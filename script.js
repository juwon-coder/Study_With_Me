...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (studies.length === 0) {
        const exampleStudies = [
            ...
            { id: 'ex3', leader: 'Park Ji-hoon', title: 'Mastering Modern JavaScript', category: 'Coding', description: 'This study covers ES6+ syntax and asynchronous programming. It uses a hybrid online/offline method.', members: 7, currentMembersCount: 7, appliedMembers: ['Kim Min-jun','Lee Seo-yeon','Choi Yu-jin','Han Ah-reum','Jung Dae-hyun','Song Ji-eun','Kang Dong-won'], method: 'Hybrid', schedule: 'Tue 7 PM every week', deadline: '2026-01-15', status: 'Recruitment completed', createdAt: new Date().toISOString() },
